...
def test_single_aggregate_url_contract():
    ...
    aggregate = main._build_aggregate_search_result(
        query="example query",
    ...
    assert aggregate.searchbox_url == "searchbox://aggregate/test-request"
    assert aggregate.aggregate_url == "searchbox://aggregate/test-request"
